...
export default function MoodlyApp() {
  ...
  if (view === "auth") return <Auth email={email} setEmail={setEmail} otp={otp} setOtp={setOtp} otpSent={otpSent} sending={authSending} toast={toast} onRequestCode={requestCode} onVerifyCode={verifyCode} onReset={() => { setOtpSent(false); setOtp(""); }} onBack={() => navigate("welcome")}/>;
